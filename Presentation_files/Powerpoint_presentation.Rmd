...
$$p_{j2} = \mbox{logit}^{-1}(\beta_0 + \beta_{j2})$$

$$p_{j2 + i} = \mbox{logit}^{-1}(\beta_0 + \beta_{j2} + \beta_i)$$
...
- Say your stakeholder is interested in the magnitude of effect that having a pet fish has on passing Balloon Animal-Making

--

- Choose some baseline: let's randomly pick _p_ = .25

--

- Plug it into the equation:

$$\log\left(\begin{array}{c}\frac{p}{1 - p}\end{array}\right) = \beta_0 + \beta_{fish}x_{fish} + \beta_1x_1 + \ldots + \beta_nx_n$$ 

--

$$\log\left(\begin{array}{c}\frac{0.25}{1-0.25}\end{array}\right) = \beta_0 + \beta_{fish}x_{fish} + \beta_1x_1 + \ldots + \beta_nx_n$$

--

$$-1.098612 =  \beta_0 + \beta_{fish}x_{fish} + \beta_1x_1 + \ldots + \beta_nx_n$$
--

- Someone who does not own a pet fish will have $x_{fish}$ = 0

--


$$-1.098612 =  \beta_0 + \beta_{fish}0 + \beta_1x_1 + \ldots + \beta_nx_n$$
--

$$-1.098612 =  \beta_0 + \beta_1x_1 + \ldots + \beta_nx_n \\$$


---
# Banana graphs

- Another student: **exact same characteristics as this student who *doesn't* own a pet fish and has a 25% predicted probability of passing** 
  
--
  
  - *Except* that they **own a pet fish**
...
$$\log\left(\begin{array}{c}\frac{p}{1 - p}\end{array}\right) = \beta_0 + \beta_{fish}(1) + \beta_1x_1 + \ldots + \beta_nx_n$$

--

$$\log\left(\begin{array}{c}\frac{p}{1 - p}\end{array}\right) = \beta_{fish}(1) + [\beta_0  + \beta_1x_1 + \ldots + \beta_nx_n]$$
...
$$\log\left(\begin{array}{c}\frac{p}{1 - p}\end{array}\right) = \beta_{fish}(1) + \boxed{[\beta_0  + \beta_1x_1 + \ldots + \beta_nx_n]}$$
...
$$\log\left(\begin{array}{c}\frac{p}{1 - p}\end{array}\right) = \beta_{fish}(1) + (-1.098612)$$

--

$$\log\left(\begin{array}{c}\frac{p}{1 - p}\end{array}\right) = (-1.19359401)(1) + (-1.098612)$$
...
.pull-left[
```{r banana_graph_highlighted_plot,  out.width = "100%", fig.width = 4.4, fig.asp = 1.3, fig.retina = 6}
banana.p +
  coord_cartesian(xlim = c(0, 1),  ylim = c(0, 1), clip = "off") 
# +
...
```{r banana_graph_highlighted_plot_two, out.width = "50%", fig.asp = 1.3, fig.retina = 6}
banana.p +
  coord_cartesian(xlim = c(0, 1),  ylim = c(0, 1), clip = "off") +
  annotate("segment", x = 0.4, xend = 0.4, y = 0.4,
           yend = invlogit(logit(0.4) +
...
- Strong cauasal interpretation

{{content}}

--

- Range of uncertainty depends in part on how many simulations you run
