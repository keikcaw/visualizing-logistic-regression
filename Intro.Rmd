...
Two important characteristics of logistic regression curve are:

1. Where a point is on the curve above depends on what combinations of $\beta$s was "switched on" by the X~i~s. 
